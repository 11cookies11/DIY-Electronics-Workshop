...
当前实现建议已经进一步收敛成下面这条原则：

- 前台 Agent 先像接待一样正常聊天
- preview 和 handoff 是聊天过程中悄悄准备好的后台产物
- 不要求用户显式说“生成 preview”或“整理 handoff”才能开始准备
...
然后在合适的时机，由 Agent 用自然话术对外说：

- “我这边已经能先摆一版结构了，要不要我给你起个 3D 预览？”
- “我已经能先替你收一版交接内容了，要不要我把 handoff 摆给你看？”

## v1.1 补充：不要把设备类别当成用户入口
...
这些类别更适合作为系统内部 archetype，而不是用户输入门槛。
...
系统再根据这些信息，内部软推断更像哪一类设备，并决定下一轮追问顺序与 preview 结构方向。
